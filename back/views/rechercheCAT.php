...
if(  isset($_POST['recherche']))
{
  ...
  $clientC = new clientC();
  $result= $clientC->afficherCatRecherche($_POST['recherche']);
?>
<!DOCTYPE html>
<html lang="en">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Edit"
                                                         href="modiferCL.php?id=<?php echo $row['idProduitsCategorie']; ?>">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </a>
                                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Delete" 
                                                        href="supprimerCL.php?id=<?php echo $row['idProduitsCategorie']; ?>">
